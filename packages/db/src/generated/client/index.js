...
const config = {
  generator: {
    ...
    output: {
      value:
        '/home/ayush_mukkanwar/Dev/Projects/uploader/packages/db/src/generated/client',
      fromEnvVar: null,
    },
    config: {
      engineType: 'library',
  ...
  inlineSchemaHash:
    '065114ce6d678a7be07bcdce31888ded8be497b2ff735ec5c785a61820fdc49f',
  copyEngine: true,
};
...
path.join(
  process.cwd(),
  'src/generated/client/libquery_engine-linux-musl-openssl-3.0.x.so.node'
);
...
path.join(
  process.cwd(),
  'src/generated/client/libquery_engine-debian-openssl-1.1.x.so.node'
);
// file annotations for bundling tools to include these files
