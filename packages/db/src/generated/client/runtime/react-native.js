...
R.precision = R.sd = function (e) {
  ...
  return (
    r.d ? ((t = Yi(r.d)), e && r.e + 1 > t && (t = r.e + 1)) : (t = NaN),
    t
  );
};
R.round = function () {
...
var hu = (e) => e,
  ...
  D = {
    ...
    util: {
      ...
      objId: function (e) {
        return (
          e.__id || Object.defineProperty(e, '__id', { value: ++yu }),
          e.__id
        );
      },
...
function bt(e = {}) {
  ...
  return Object.entries(t).reduce(
    (n, [i, o]) => (
      Jo[i] !== void 0 ? (n.select[i] = { select: o }) : (n[i] = o),
      n
    ),
    { select: {} }
  );
